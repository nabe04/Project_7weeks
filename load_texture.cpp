...
namespace n_texture
{
	...
	int sprCounterEffect[COUNTER_EFFECT_CHIP_NUM]; //カウンターブロックのエフェクト
	int sprArrow[NO_ANIMATION];					   //矢印
	int sprIndexLine[NO_ANIMATION];				   //指標(Tutorialの挟むライン)
	int sprIndexCursor[NO_ANIMATION];			   //指標(Tutorialの自分のカーソル)
