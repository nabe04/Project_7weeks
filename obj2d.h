...
public:
	...
	OBJ2D* add(MoveAlg* mvAlg, int* data, e_Category category, const n_setup::Vector2F& pos = n_setup::Vector2F{ 0, 0 }, const n_setup::Vector2F& size = n_setup::Vector2F{0,0},char* loadName = nullptr,float maxVal = 0,bool turnFrag = false, e_Direction direction = YOKO);	//objListに新たなOBJ2Dを追加する
